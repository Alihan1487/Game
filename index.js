...
var ASM_CONSTS = {
  45691612: ($0, $1) => { console.log($0,$1); },  
 45691634: () => { FS.syncfs(false,function (err){}); console.log("saved"); },  
 45691691: () => { FS.mkdir("/save"); FS.mount(IDBFS,{},"/save"); FS.syncfs(true,function (err){ if (err){ console.error("error",err) } else{ console.log("loading"); _load(0); } }); },  
 45691854: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 45692069: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 45692216: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['save'] != 'undefined', 'missing Wasm export: save');
  _save = Module['_save'] = createExportWrapper('save', 0);
  assert(typeof wasmExports['load'] != 'undefined', 'missing Wasm export: load');
  _load = Module['_load'] = createExportWrapper('load', 1);
