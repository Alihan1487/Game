...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/Arialmt.ttf", "start": 0, "end": 367112}, {"filename": "/assets/bg.png", "start": 367112, "end": 441051}, {"filename": "/assets/plr.png", "start": 441051, "end": 475076}, {"filename": "/assets/reload.wav", "start": 475076, "end": 673298}, {"filename": "/assets/shot.wav", "start": 673298, "end": 752096}, {"filename": "/assets/versus.wav", "start": 752096, "end": 45062702}, {"filename": "/assets/wall.png", "start": 45062702, "end": 45132374}], "remote_package_size": 45132374});

  })();

// end include: /tmp/tmpy68lb7v5.js
// include: /tmp/tmpmw0h2o4m.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpmw0h2o4m.js
// include: /tmp/tmpk43rqiqb.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpk43rqiqb.js
...
function assignWasmExports(wasmExports) {
  assert(wasmExports['save'], 'missing Wasm export: save');
  _save = Module['_save'] = createExportWrapper('save', 0);
  assert(wasmExports['load'], 'missing Wasm export: load');
  _load = Module['_load'] = createExportWrapper('load', 0);
  ...
  assert(wasmExports['fileno'], 'missing Wasm export: fileno');
